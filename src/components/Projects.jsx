    ...
    <>
      <div id="projects" className="projects bg-[#171717] text-white py-10">
        ...
        <div className="flex justify-center items-center gap-4 mt-12 mb-2 ">
          <button
            onClick={() => setDraweropen(1)}
            className={`font-bold text-[19px] border-2  bg-[#171717] rounded-[6px] p-[4px] 
                      ${draweropen == 1 ? "bg-[linear-gradient(90deg,#b004b0,#38097a)]" : ""
              }`}
          >
            All Projects
          </button>
          <button
            onClick={() => setDraweropen(2)}
            className={`font-bold text-[19px] border-2  bg-[#171717] rounded-[6px] p-[4px]
                     ${draweropen === 2 ? "bg-[linear-gradient(90deg,#b004b0,#38097a)]" : ""
              }  `}
          >
            Text-1
          </button>
          <button
            onClick={() => setDraweropen(3)}
            className={`font-bold text-[19px] border-2  bg-[#171717] rounded-[6px] p-[4px]
                        ${draweropen === 3 ? "bg-[linear-gradient(90deg,#b004b0,#38097a)]" : ""
              }`}
          >
            Text-2
          </button>
